...
<tr><td>IPアドレス</td><td><?php echo $_SERVER['SERVER_ADDR'];?></td></tr>
...
<h2>コマンド結果（plain）</h2>
<b>hostname: </b><?php echo $hn_out[0];?><br />

<b>uptime: </b><?php echo $ut_out[0];?><br />

<b>uname: </b><?php echo $unamev_out[0];?><br />
